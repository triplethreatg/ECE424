...
class AiController():
	...
	self.pitch_error_prev = 0
	self.roll_error_prev = 0
        ...
        self.cfParams = {
            ...
            'pid_rate.pitch_ki': 10.0,
	    'pid_rate.pitch_kp':35,  # my input 
	...
	#self.updateCrazyFlieParam('pid_rate.yaw_kp')
	self.cfParams['pid_rate.yaw_kp'] = self.cfParams['pid_rate.yaw_kp'] + 10

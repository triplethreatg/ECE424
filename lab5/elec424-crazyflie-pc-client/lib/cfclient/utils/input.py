...
class JoystickReader:
    ...
    def getAvailableDevices(self):
        ...
        # devs.append({"name":"AI", "id":45323432})
        for d in devs:
            self._available_devices[d["name"]] = d["id"]

        # self._available_devices["AI"] = 45323432
        # print "getting devices ", self._available_devices
    ...
    def start_input(self, device_name, config_name):
        ...
        try:
            ...
            # if device_id == 45323432:
            #     print "AI overwriting contoller"
            #     self.inputdevice = AiController()
            # else:
            self.inputdevice.start_input( device_id, ConfigManager().get_config(config_name) )

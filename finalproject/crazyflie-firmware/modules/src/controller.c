...
PARAM_GROUP_START(pid_error)
//PARAM_ADD(PARAM_FLOAT, roll_attitude_error, &pidRollRate.error)
//PARAM_ADD(PARAM_FLOAT, pitch_attitude_error, &pidPitchRate.error)
//PARAM_ADD(PARAM_FLOAT, yaw_attitude_error, &pidYawRate.error)
PARAM_ADD(PARAM_FLOAT, roll_rate_error, &pidRoll.myError)
PARAM_ADD(PARAM_FLOAT, pitch_rate_error, &pidPitch.myError)
PARAM_ADD(PARAM_FLOAT, yaw_rate_error, &pidYaw.myError)
PARAM_GROUP_STOP(pid_error)
